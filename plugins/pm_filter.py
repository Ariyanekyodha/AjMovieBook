...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🧞‍♀️ Search 🧐', switch_inline_query_current_chat='@Aj_Movie_Search_Group'),
