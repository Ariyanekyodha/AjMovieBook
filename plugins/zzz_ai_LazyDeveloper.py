    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "🦋<a href='https://telegram.me/Aj_Support_Group'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://telegram.me/Aj_The_Warrior'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
                ...
                print(error)
                await message.reply_text(f'Error aa gya Aj Bhaiya 😀\n\n{error}')
    else:
        return
